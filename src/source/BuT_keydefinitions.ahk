...
EDS("00A",0,"9","“","‘","","⟩","∝")             ; 9
EDS("00B",0,"0","”","’","","₀","∅")             ; 0
EDSK("00C",0,"-","—","U002620" ,"S__NSub","‑","­")      ; -
EDS("00D",0,"T__grav","T__cedi","T__abrg","T__drss","T_dasia","T__mcrn") ; grave
; Reihe 2
EDSK("028",1,"ß","•","@","."      ,"ς","∘")         ; ß
EDSK("010",1,"b","B","…","S__PgUp","β","⇐")         ; b
EDSK("011",1,"u","U","_","U000008","" ,"⊂")         ; u
EDSK("012",0,".","’","[","S____Up","ϑ","↦")         ; .•
EDSK("013",0,",","–","]","S___Del","ϱ","⇒")         ; ,
EDSK("014",1,"ü","Ü","^","S__PgDn","" ,"∪")         ; ü
EDSK("015",1,"p","P","!","S__NMul","π","Π")         ; p 
EDSK("016",1,"c","C","<","S__N__7","χ","ℂ")         ; c
EDSK("017",1,"l","L",">","S__N__8","λ","Λ")         ; l
EDSK("018",1,"m","M","=","S__N__9","μ","⇔")         ; m
EDSK("019",1,"f","F","&","S__NAdd","φ","Φ")         ; f
EDSK("01A",1,"x","X","⸮","−"      ,"ξ","Ξ")         ; x
EDS("01B",0,"T__acut","T__tlde","T__strk","T__dbac","T_psili","T__brve") ; acute
; Reihe 3
EDSK("01E",1,"h","H","\","S__Home","ψ","Ψ")         ; h
EDSK("01F",1,"i","I","/","S__Left","ι","∫")         ; i
EDSK("020",1,"e","E","{","S__Down","ε","∃")         ; e
EDSK("021",1,"a","A","}","S__Rght","α","∀")         ; a
EDSK("022",1,"o","O","*","S___End","ο","∈")         ; o
EDSK("023",1,"d","D","?","S__N__0","δ","Δ")         ; d 
EDSK("024",1,"t","T","(","S__N__4","τ","∂")         ; t
EDSK("025",1,"r","R",")","S__N__5","ρ","ℝ")         ; r
EDSK("026",1,"n","N","-","S__N__6","ν","ℕ")         ; n 
EDSK("027",1,"s","S",":","S__NDot","σ","Σ")         ; s
; Reihe 4
EDSK("02C",1,"k","K","#","U00001B","κ","×")         ; k
EDSK("02D",1,"y","Y","$","U000009","υ","∇")         ; y
EDSK("02E",1,"ö","Ö","|","S___Ins","ϵ","∩")         ; ö
EDSK("02F",1,"ä","Ä","~","U00000D","η","ℵ")         ; ä
EDSK("030",1,"q","Q","``",".","ϕ","ℚ")              ; q
EDSK("031",1,"j","J","+","S__NDiv","θ","Θ")         ; j
EDSK("032",1,"g","G","%","S__N__1","γ","Γ")         ; g
EDSK("033",1,"w","W","""","S__N__2","ω","Ω")        ; w
EDSK("034",1,"v","V","'","S__N__3","" ,"√")         ; v
EDSK("035",1,"z","Z",";","S__NSub","ζ","ℤ")         ; z
...
; other keys
ED("space",0,"U000020","U000020","U000020","U000020","U0000A0","U00202F")
  ED("05C",0,"U000020","U000020","U000020","U000020","U0000A0","U00202F")   ;code 2nd spacekey
...
Change1256Layout(newlayoutstring) {
  ...
  if (strlen(newlayoutstring) != 33) {
    MsgBox,Falscher Layoutstring, es müssen 33 Zeichen sein! `nKeine Belegung gespeichert!
  if (nch = 8)
...
; Modifier
  ...
  */
  ...
  ; CSU0000B4 := chr(180)   ; ´
  CSU0000B5 := chr(181)   ; µ
;  CSU0000C4 := chr(196)   ; Ä     ;    ab hier abgestellt!!!
;  CSU0000D6 := chr(214)   ; Ö
;  CSU0000DC := chr(220)   ; Ü
;  CSU0000DF := chr(223)   ; ß
;  CSU0000E4 := chr(228)   ; ä
...
; Modifier
  ...
  */
  ...
  ; CSU0000DC := chr(220)   ; Ü
  ; CSU0000DF := chr(223)   ; ß
;  CSU0000E0 := chr(224)   ; à          ;ab hier ausgestellt
;  CSU0000E4 := chr(228)   ; ä
;  CSU0000E8 := chr(232)   ; è
;  CSU0000E9 := chr(233)   ; é
;  CSU0000F6 := chr(246)   ; ö
;  CSU0000FC := chr(252)   ; ü          ;bis hier ausgestellt
  ; CSU0000FF := chr(255)   ; ÿ
